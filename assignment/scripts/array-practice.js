...
let favoriteFoods = ['pea soup', 'cabage soup', 'pizza']
...
console.log('In array of', animalArray, 'last animal is', lastAnimal);
...
let lastAnimalOtherWay = animalArray[animalArray.length - 1];
console.log('---Last animal is', lastAnimalOtherWay )
...
let dessertToPush = 'nutella spread';
favoriteFoods.push(dessertToPush);
console.log('---Updated favoriteFoods array with dessert is', favoriteFoods);
...
console.log('---Updated favoriteFoods array with an entree is', favoriteFoods)
...
console.log('---Removed last color is', lastColorRemoved);
console.log("---New color's array is", colors)
...
console.log('--Removied first color is', firstColor);
console.log('--Colors array without first color', colors);
...
let newSecondGem = gems[1] = 'Tourmaline';
console.log('-- New second gem is', newSecondGem);
...
gems.sort().reverse();
console.log('--Gems array in reverse alphabetical order is', gems);
...
console.log('--Gems in an arrray are ', gemString)
...
console.log('--Gems and colors array is', colorfulGems)
